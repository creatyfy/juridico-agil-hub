-- WhatsApp customer linkage + secure conversational state machine
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      ...
      AND policyname = 'Users can select own tenant whatsapp contacts'
  ) THEN
    CREATE POLICY "Users can select own tenant whatsapp contacts"
  ...
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      AND tablename = 'whatsapp_contacts'
      AND policyname = 'Users can insert own tenant whatsapp contacts'
  ) THEN
    CREATE POLICY "Users can insert own tenant whatsapp contacts"
      ON public.whatsapp_contacts
      FOR INSERT
  ...
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      AND tablename = 'whatsapp_contacts'
      AND policyname = 'Users can update own tenant whatsapp contacts'
  ) THEN
    CREATE POLICY "Users can update own tenant whatsapp contacts"
      ON public.whatsapp_contacts
      FOR UPDATE
      USING (auth.uid() = tenant_id)
      WITH CHECK (auth.uid() = tenant_id);
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      ...
      AND policyname = 'Users can select own tenant conversation logs'
  ) THEN
    CREATE POLICY "Users can select own tenant conversation logs"
