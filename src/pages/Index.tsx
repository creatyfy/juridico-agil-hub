            ...
            <div className="max-w-xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mt-10">
                <Link to="/cadastro/advogado">
                  <Button size="lg" className="btn-accent text-lg px-10 h-14 font-semibold shadow-lg shadow-accent/25 hover:shadow-xl hover:shadow-accent/30 transition-all">
      ...
      <section className="hero-section py-20 md:py-28 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-8 text-center relative">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/cadastro/advogado">
              <Button size="lg" className="btn-accent text-lg px-10 h-14 font-semibold shadow-lg shadow-accent/25">
                Criar Conta Gratuita
                <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
            </Link>
            <Link to="/login">
              <Button size="lg" variant="outline" className="text-lg px-10 h-14 border-primary-foreground/30 text-primary-foreground hover:bg-primary-foreground/10 bg-transparent">
                Já tenho conta
              </Button>
            </Link>
          </div>
